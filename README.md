...
* [arrayHelpers](#module_arrayHelpers)
    ...
    * [~uniqueArray(...arrays)](#module_arrayHelpers..uniqueArray) ⇒ <code>Array</code>
...
### arrayHelpers~uniqueArray(...arrays) ⇒ <code>Array</code>
...
* [functionHelpers](#module_functionHelpers)
    ...
    * _inner_
        ...
        * [~queueManager([queue])](#module_functionHelpers..queueManager) ⇒ [<code>handle</code>](#queueManager..handle)
        * [~queueTimeout([queue])](#module_functionHelpers..queueTimeout) ⇒ [<code>handle</code>](#queueTimeout..handle)
...
### functionHelpers~queueManager([queue]) ⇒ [<code>handle</code>](#queueManager..handle)
...
### functionHelpers~queueTimeout([queue]) ⇒ [<code>handle</code>](#queueTimeout..handle)
...
**Kind**: inner method of [<code>numberHelpers</code>](#module_numberHelpers)  
...
* [objectHelpers](#module_objectHelpers)
    ...
    * [~mapArrayProperty(property, mapFunction, obj)](#module_objectHelpers..mapArrayProperty) ⇒ <code>object</code>
...
<a name="module_objectHelpers..mapArrayProperty"></a>

### objectHelpers~mapArrayProperty(property, mapFunction, obj) ⇒ <code>object</code>
...
| Param | Type | Default | Description |
| --- | --- | --- | --- |
| fn | <code>module:objectHelpers.mergeObjects</code> \| <code>module:objectHelpers.mergeObjectsMutable</code> \| <code>function</code> |  | Pass one of the mergeObjects functions to be used |
